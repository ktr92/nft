function initFE() {
  ...
  closeByClickOutside(
    '[data-toggle="searchtoggler"]',
    '[data-toggleclick="searchtoggler"]'
  )
  closeByClickOutside(
  ...
  $('[data-slider="repostslider"]').each(function () {
    ...
    $('[data-slider="repostslider"]').on(
      ...
      function (e, s, currentSlideIndex) {
        ...
        $(this)
          .closest(".modal")
          .find('[data-click="copy-img"]')
          .attr("data-clickindex", previousSlideIndex)
        $(this)
          .closest(".modal")
          .find('[data-click="download-img"]')
          .attr("data-downloadindex", previousSlideIndex)
      }
    )
  })
}
...
$(document).ready(function () {
  ...
  $('.searchtoggler input').on('change', function () {
    $(this).closest('.searchtoggler__items').removeClass('active')
    $(this).closest('.searchtoggler').find('.searchtoggler__button span').text($(this).siblings('label').text())
  }) 
})
